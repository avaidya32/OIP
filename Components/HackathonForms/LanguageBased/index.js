...
import styles from "./language-based.module.scss";
import { Container, Row, Col, Button, Form } from "react-bootstrap";

const LanguageBased = ({ client_id }) => {
          ...
          <Col className={styles.col}>
            ...
            <div className={styles.formContainer}>
              <Form>
                ...
                <p>Selected Programing Language:</p>
                <Form.Group controlId="Language" className={styles.formGroup}>
                  <Form.Control
                    maxLength={50}
                    aria-label="name-edit"
                    className={styles.control}
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    fetch("/api/hackathon/putinfo/language", {
                      method: "POST",
                      body: JSON.stringify({
                        ClientId: client_id,
                        OrgName: orgname,
