...
module.exports = {
    ...
    // },
    env:{
        MONGO_URI: "mongodb+srv://vaidya:Password1@clustervd-yc94p.mongodb.net/test?retryWrites=true&w=majority"
    },
    cssLoaderOptions: {
        url: true,
        importLoaders: 1,
        ...
        getLocalIdent: (context, localIdentName, localName, options) => {
            ...
            const resourcePath = resourcePathSplit[resourcePathLength - 1].split('.')[0];
